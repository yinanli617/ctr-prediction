...
train.repartition(train_repartition) \
     .write \
     .mode('overwrite') \
     .parquet('gs://pyspark-yli/avazu-ctr-prediction/training_parquet')

test.repartition(val_repartition) \
    .write \
    .mode('overwrite') \
    .parquet('gs://pyspark-yli/avazu-ctr-prediction/validation_parquet')
